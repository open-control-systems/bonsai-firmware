...
private:
...
#ifdef CONFIG_BONSAI_FIRMWARE_SENSOR_LDR_ANALOG_ENABLE
    static constexpr const char* ldr_sensor_config_storage_id_ = "ldr_a_cfg";
    static constexpr const char* ldr_sensor_id_ = "ldr_a0";

    static constexpr const char* ldr_config_handler_path_ =
        "/api/v1/sensor/ldr/analog/config";

    storage::StorageBuilder::IStoragePtr ldr_sensor_config_storage_;
    ...
    std::unique_ptr<pipeline::httpserver::AnalogConfigStoreHandler>
        ldr_sensor_config_store_handler_;
#endif // CONFIG_BONSAI_FIRMWARE_SENSOR_LDR_ANALOG_ENABLE

#ifdef CONFIG_BONSAI_FIRMWARE_SENSOR_SOIL_ANALOG_RELAY_ENABLE
    static constexpr const char* soil_relay_sensor_config_storage_id_ = "soil_ar_cfg";
    static constexpr const char* soil_relay_sensor_id_ = "soil_ar0";

    static constexpr const char* soil_relay_config_handler_path_ =
        "/api/v1/sensor/soil/relay/analog/config";

    storage::StorageBuilder::IStoragePtr soil_relay_sensor_config_storage_;
    ...
    std::unique_ptr<sensor::AnalogConfigStore> soil_relay_sensor_config_store_;

    std::unique_ptr<pipeline::httpserver::AnalogConfigStoreHandler>
        soil_relay_sensor_config_store_handler_;
#endif // CONFIG_BONSAI_FIRMWARE_SENSOR_SOIL_ANALOG_RELAY_ENABLE

#ifdef CONFIG_BONSAI_FIRMWARE_SENSOR_SOIL_ANALOG_ENABLE
    static constexpr const char* soil_sensor_config_storage_id_ = "soil_a_cfg";
    static constexpr const char* soil_sensor_id_ = "soil_a0";

    static constexpr const char* soil_config_handler_path_ =
        "/api/v1/sensor/soil/analog/config";

    storage::StorageBuilder::IStoragePtr soil_sensor_config_storage_;
    ...
    std::unique_ptr<sensor::AnalogConfigStore> soil_sensor_config_store_;

    std::unique_ptr<pipeline::httpserver::AnalogConfigStoreHandler>
        soil_sensor_config_store_handler_;
#endif // CONFIG_BONSAI_FIRMWARE_SENSOR_SOIL_ANALOG_ENABLE
